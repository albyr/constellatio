<?php
	...
	$constellation = "Draco"; // Latin name of constellation
	$alsoknown = "the Dragon"; // Alternate 'symbolism' name
	$imageURL = "draco.png"; // Relative URL to constellation image
	$description = "Draco is a constellation in the far northern sky, close to the north pole star."; // Description of constellation
	$visible = "To help you find Draco, the link below will show you the current position of Thuban, its brightest star."; // How to find this constellation in the night sky
	$findlink = "http://wolfr.am/181SM69"; // Link to constellation location
?>
