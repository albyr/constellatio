<?php
	...
	$description = "Apus is a constellation in the southern sky. It's name means &ldquo;no feet&rdquo; as it is named after the Bird-of-Paradise, which was once believed to have no feet."; // Description of constellation
