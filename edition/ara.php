<?php
	...
	$constellation = "Ara"; // Latin name of constellation
	$alsoknown = "the Altar"; // Alternate 'symbolism' name
	$imageURL = "ara.png"; // Relative URL to constellation image
	$description = "Ara is a constellation in the southern sky that crosses with the Milky Way, giving it rich star fields."; // Description of constellation
	$visible = "To help you find Ara, the link below will show you the current position of Beta Arae, its brightest star."; // How to find this constellation in the night sky
	$findlink = "http://wolfr.am/T12oEc"; // Link to constellation location
?>
