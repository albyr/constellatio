<?php
	...
	$constellation = "Equuleus"; // Latin name of constellation
	$alsoknown = "the Pony"; // Alternate 'symbolism' name
	$imageURL = "equuleus.png"; // Relative URL to constellation image
	$description = "Equuleus is the second-smallest of the 88 modern constellations, second only to Crux (the Southern Cross)."; // Description of constellation
	$visible = "To help you find Equuleus, the link below will show you the current position of Kitalpha, it's brightest star."; // How to find this constellation in the night sky
	$findlink = "http://wolfr.am/17ZZNyK"; // Link to constellation location
?>
