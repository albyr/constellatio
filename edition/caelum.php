<?php
	...
	$constellation = "Caelum"; // Latin name of constellation
	$alsoknown = "the Chisel"; // Alternate 'symbolism' name
	$imageURL = "caelum.png"; // Relative URL to constellation image
	$description = "Caelum is one of the smallest and faintest constellations in the southern sky."; // Description of constellation
	$visible = "To help you find Caelum, the link below will show you the current position of Beta Caeli, its central star. One of its stars, Gamma Caeli, is actually a double star."; // How to find this constellation in the night sky
	$findlink = "http://wolfr.am/W8x4Fs"; // Link to constellation location
?>
