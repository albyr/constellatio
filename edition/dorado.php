<?php
	...
	$constellation = "Dorado"; // Latin name of constellation
	$alsoknown = "the Swordfish"; // Alternate 'symbolism' name
	$imageURL = "dorado.png"; // Relative URL to constellation image
	$description = "Dorado is a small southern constellation and contains most of the Large Magellanic Cloud."; // Description of constellation
	$visible = "To help you find Dorado, the link below will show you the current position of Alpha Doradus, its brightest star."; // How to find this constellation in the night sky
	$findlink = "http://wolfr.am/1a082QJ"; // Link to constellation location
?>
