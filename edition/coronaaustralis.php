<?php
	...
	$constellation = "Corona Australis"; // Latin name of constellation
	$alsoknown = "the Southern Crown"; // Alternate 'symbolism' name
	$imageURL = "coronaaustralis.png"; // Relative URL to constellation image
	$description = "Corona Australis is a small constellation surrounded by Sagittarius, Scorpius, Telescopium and Ara."; // Description of constellation
	$visible = "To help you find Corona Austrailis, the link below will show you the current position of Alpha Corona Australis, its brightest star."; // How to find this constellation in the night sky
	$findlink = "http://wolfr.am/12LLTOE"; // Link to constellation location
?>
